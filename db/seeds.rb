...
sixteen.lookslikes.create!(name: 'Jay Cutler',
...
sixteen.lookslikes.create!(name: 'Tom Thibodeau',
...
sixteen.lookslikes.create!(name: 'Wade Phillips',
...
sixteen.lookslikes.create!(name: 'Paul Finebaum',
...
sixteen.lookslikes.create!(name: 'Steve Kerr',
...
sixteen.lookslikes.create!(name: 'Greg Olsen',
...
sixteen.lookslikes.create!(name: 'Jay Gruden',
...
sixteen.lookslikes.create!(name: 'Lane Kiffin',
...
sixteen.lookslikes.create!(name: 'Brian Dawkins',
...
sixteen.lookslikes.create!(name: 'Matthew Stafford ',
...
sixteen.lookslikes.create!(name: 'Ty Lawson',
...
sixteen.lookslikes.create!(name: 'Russell Wilson ',
...
sixteen.lookslikes.create!(name: 'Roy Williams',
...
sixteen.lookslikes.create!(name: 'Dana Holgorsen',
...
sixteen.lookslikes.create!(name: 'Barry Melrose',
...
sixteen.lookslikes.create!(name: 'Kurt Warner',
...
sixteen.lookslikes.create!(name: 'Jeff Fisher',
...
sixteen.lookslikes.create!(name: 'Romeo Crennel',
...
sixteen.lookslikes.create!(name: 'Jeff Van Gundy',
...
sixteen.lookslikes.create!(name: 'Jim Tomsula',
...
sixteen.lookslikes.create!(name: 'Bo Ryan',
...
sixteen.lookslikes.create!(name: 'Jeremy Shockey',
...
sixteen.lookslikes.create!(name: 'Joe Buck',
...
sixteen.lookslikes.create!(name: 'Pablo Torre',
...
sixteen.lookslikes.create!(name: 'Gary Kubiak',
...
sixteen.lookslikes.create!(name: 'Mike Tomlin',
...
sixteen.lookslikes.create!(name: 'Buck Showalter',
...
sixteen.lookslikes.create!(name: 'Urban Meyer',
...
sixteen.lookslikes.create!(name: 'Chuck Pagano',
...
sixteen.lookslikes.create!(name: 'Tim Legler',
...
sixteen.lookslikes.create!(name: 'Rick Fox',
...
sixteen.lookslikes.create!(name: 'Scott Van Pelt',
...
sixteen.lookslikes.create!(name: 'Bob Ley',
...
sixteen.lookslikes.create!(name: 'Stan Van Gundy',
...
sixteen.lookslikes.create!(name: 'Jameis Winston',
